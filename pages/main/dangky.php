...
<div class="main">
        <form action="" method="POST" class="form" id="form-1">
          ...
          <div class="form-group">
            ...
            <input  name="hovaten" type="text" placeholder="VD: Nguyễn Văn A" class="form-control">
          ...
          <div class="form-group">
            <label for="email" class="form-label">Điện thoại</label>
          ...
          <button  class="form-submit" type="submit" name="dangky">Đăng ký</button>
          <br>
